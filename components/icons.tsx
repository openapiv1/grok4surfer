...
export const GrokLogo = ({
  ...
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm-1-13v6l5-3-5-3z"/>
...
export const MistralLogo = ({
  ...
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L19.82 8 12 11.82 4.18 8 12 4.18zM4 9.18l7 3.5v8.14l-7-3.5V9.18zm16 0v8.14l-7 3.5V12.68l7-3.5z"/>
    </svg>
  );
};
